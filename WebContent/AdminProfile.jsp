...
function subs() {
	...
	if(email=='')
		...
		{
		document.forms[0].action="AdminProfile.jsp";
...
<% 
		...
		if(request.getParameter("email")!=null)
		{
			...
			{
				row=Admin.profile(request.getParameter("email"),"A",id);
			}
			else
			{

				row=Admin.profile(request.getParameter("email"),request.getParameter("pass"),id);	
			}

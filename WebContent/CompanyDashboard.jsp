				...
				<div class="row ">
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="tile tile-primary">
							<div class="tile-heading">Total Interview Request</div>
							<div class="tile-body">
								<i class="fas fa-podcast" style="margin: 5%;"></i>
								<h2 class="pull-right"><%=Company.countInterviweReqestPending(id) %></h2>
							</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6">
						<div class="tile tile-primary">
							<div class="tile-heading">Total Accepted Interview</div>
							<div class="tile-body">
								<i class="fas fa-podcast" style="margin: 5%;"></i>
								<h2 class="pull-right"><%=Company.countInterviweReqestAccepted(id) %></h2>
							</div>

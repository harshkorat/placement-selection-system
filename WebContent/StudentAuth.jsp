...
function subs() {
	...
	if(email=='')
		...
		{
		document.forms[0].action="StudentAuth.jsp";
...
<% 
		...
		if(request.getParameter("email")!=null)
		{
			...
			{
				row=Student.profile(request.getParameter("email"),"A",id);
			}
			else
			{

				row=Student.profile(request.getParameter("email"),request.getParameter("pass"),id);	
			}
			...
			{
				response.sendRedirect("StudentAuth.jsp");
			}
		}
%>

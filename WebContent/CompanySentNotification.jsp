...
<title>Company | Send Notification</title>
...
function subs() {
	...
	if(des=='')
		...
		{
		document.forms[0].action="CompanySentNotification.jsp";
...
<% 
		...
		if(request.getParameter("des")!=null)
		{
			...
			{
				row=Company.notification(id, Integer.parseInt(request.getParameter("sid")),request.getParameter("des"));
				if(row>0)
				{
				...
				{
					response.sendRedirect("CompanySentNotification.jsp");
				}	
			}
                    ...
                    <div class="panel-body ">
                         <form action="" method="post"  class="form-horizontal">
					                <div class="form-group required ">
                                        ...
                                        <div class="col-sm-8">
                                        <input type="text" name="n" value="<%=Company.getNotificationSenderName(Integer.parseInt(request.getParameter("sid"))) %>"  id="input-n" class="form-control" readonly="readonly" required="required">

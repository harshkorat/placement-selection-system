...
List<List<String>> rs1=Admin.getstudentRecords(iPageNo, showRows);;
 List<List<String>> rs2=Admin.studentfoundRow();
...
%>
		...
		<div id="content " >
			<div class="page-header">
				...
				<div class="container-fluid ">
					...
					<h2 class="col-md-11 col-md-push-1 col-sm-12">Student </h2>
				</div>
			</div>
     ...
     for(List<String> b:rs3)
    {
            ...
            %>
             ...
             <li class='page-item pagination'><span id="previous"><a href="StudentDisplay.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>" class="numbersFont">Previous</a></span></li>
            <%
                }
                for (i = ((cPage * totalRecords) - (totalRecords - 1)); i <= (cPage * totalRecords); i++) {
                    if (i == ((iPageNo / showRows) + 1)) {%>
             <li class='page-item pagination'><span class="numbers"><a href="StudentDisplay.jsp?iPageNo=<%=i%>" class="numbersFont"class="numbersFont"><%=i%></a></span></li>
                <%
             ...
             <li class='page-item pagination'><span class="numbers"><a href="StudentDisplay.jsp?iPageNo=<%=i%>" class="numbersFont" class="numbersFont"><%=i%></a></span></li>
                ...
                %>
             <li class='page-item '><span id="next"><a href="StudentDisplay.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>" class="numbersFont">Next</a></span></li>
            <%
                    }
                }
